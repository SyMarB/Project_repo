...
embWDR5_G.Ex <-subset(embWDR5_NEW_genetype,select=c(GeneID, gene_type))
...
embRBBP5_G.Ex <-subset(embRBBP5_NEW_genetype,select=c(GeneID, gene_type))
...
YAWDR5_G.Ex <-subset(YAWDR5_NEW_genetype,select=c(GeneID, gene_type))
...
YARBBP5_G.Ex <-subset(YARBBP5_NEW_genetype,select=c(GeneID, gene_type))
