...
# Sort WBGene by ascending order
embWDR5_NEW$WBGene<-as.numeric(embWDR5_NEW$WBGene)
embWDR5_NEW<-embWDR5_NEW[order(embWDR5_NEW$WBGene),]
...
# Sort WBGene by ascending order
embRBBP5_NEW$WBGene<-as.numeric(embRBBP5_NEW$WBGene)
embRBBP5_NEW<-embRBBP5_NEW[order(embRBBP5_NEW$WBGene),]
# saving table as a csv file
...
# Sort WBGene by ascending order
YAWDR5_NEW$WBGene<-as.numeric(YAWDR5_NEW$WBGene)
YAWDR5_NEW<-YAWDR5_NEW[order(YAWDR5_NEW$WBGene),]
# saving table as a csv file
...
# Sort WBGene by ascending order
YARBBP5_NEW$WBGene<-as.numeric(YARBBP5_NEW$WBGene)
YARBBP5_NEW<-YARBBP5_NEW[order(YARBBP5_NEW$WBGene),]
# saving table as a csv file
